...
# Now we should be able to import munin, even if we don't have the deps:
import munin
...
version = munin.__version__

# The full version, including alpha/beta/rc tags.
release = munin.__version__
...
html_title = 'rmlint ({version}) apidoc'.format(version=version)
