...
static art_node **find_child(art_node *n, unsigned char c) {
    ...
    case NODE4:
        ...
        case NODE16:
            ...
            cmp =
                _mm_cmpeq_epi8(_mm_set1_epi8(c), _mm_loadu_si128((__m128i *)p.p2->keys));
...
static void add_child16(art_node16 *n, art_node **ref, unsigned char c, void *child) {
    if(n->n.num_children < 16) {
        ...
        memcpy(new->children, n->children, sizeof(void *) * n->n.num_children);
...
static void *recursive_insert(art_node *n, art_node **ref, unsigned char *key,
...
static art_leaf *recursive_delete(art_node *n, art_node **ref, unsigned char *key,
 ...
 * @return 0 on success, or the return of the callback.
 */
int art_iter_prefix(art_tree *t, unsigned char *key, int key_len, art_callback cb,
                    void *data) {
    art_node **child;
    art_node *n = t->root;
    int prefix_len, depth = 0;
