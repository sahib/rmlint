...
static const char rm_py_bootstrap[] =
    ...
    "\n"
    "# Prefer the source-tree GUI when running an uninstalled checkout.\n"
    "local_gui = os.path.join(os.getcwd(), 'gui')\n"
    "if os.path.exists(os.path.join(local_gui, 'shredder', '__init__.py')):\n"
    "    sys.path.insert(0, local_gui)\n"
    "if os.path.exists(os.path.join(os.getcwd(), 'rmlint')):\n"
