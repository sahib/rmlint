...
#define FUNC(name) ((GOptionArgFunc)rm_cmd_parse_##name)
    ...
    */
    ...
    const GOptionEntry main_option_entries[] = {
        ...
        {"no-keep-symlinks"         , 0    , DISABLE   , G_OPTION_ARG_NONE      , &cfg->keep_symlinks            , _("Do not mark symlinks as original")                                     , NULL}     ,
    ...
    const GOptionEntry inversed_option_entries[] = {
        ...
        {"keep-symlinks"              , 0   , HIDDEN           , G_OPTION_ARG_NONE     , &cfg->keep_symlinks            , _("Mark symlinks as original")       , NULL} ,
