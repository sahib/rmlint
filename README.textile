...
<h3>RMLINT IS KNOWN FINE TO RUN ON THOSE PLATFORMS:</h3>
* Linux 32/64
* Solaris
...
__Longer:__They would need to have the same size, fingerprint and checksums to be marked as twins.
...
*Q:* __Can I set a 'preferred dir' when specifying more than one dir, which picks the orig from the preferred one?
